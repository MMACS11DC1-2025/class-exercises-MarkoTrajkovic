...
for x in range(len(images_raw)):
    ...
    total_pixels = width * height - len(other_pixels)
    ...
    avg_percent = (red_percent + blue_percent + white_percent)/3
    ...
    if 20 <= white_percent <= 50:
        count += 1
    if 20 <= red_percent <= 60:
        count += 1
    if 10 <= blue_percent <= 30:
        count += 1

    if count == 0:
        print("I am 0% sure this is an american flag.")
    elif count == 1:
        print("I am 33% sure this is an american flag.")
    elif count == 2:
        print("I am 66% sure this is an american flag.")
    elif count == 3:
        print("I am 100% sure this is an american flag.")
